...
// ------------------------------------------------------------
const SPRITE = {
  frameWidth: 211, // width of one frame  (300px / 4 frames)
  frameHeight: 316, // height of one frame (600px / 4 rows)
...
function preload() {
  ...
  characterSheet = loadImage("assets/images/man_walking.png");
}
